...
# List beneficiary address countries

> Lists the countries accepted in beneficiary address fields. Admits a customer token and answers synchronously. This list is independent from residence and payout-destination countries.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/beneficiaries/address-countries
openapi: 3.1.0
info:
  summary: >-
...
tags:
  ...
  - description: >-
    ...
    name: Webhooks
paths:
  /v1/beneficiaries/address-countries:
    get:
      tags:
        - Beneficiaries
      summary: List beneficiary address countries
      description: >-
        Lists the countries accepted in beneficiary address fields. Admits a
        customer token and answers synchronously. This list is independent from
        residence and payout-destination countries.
      operationId: beneficiary_address_countries
      responses:
        '200':
          content:
            application/json:
              schema:
                items:
                  $ref: '#/components/schemas/AddressCountryView'
                title: Response Beneficiary Address Countries
                type: array
...
components:
  schemas:
    AddressCountryView:
      ...
      description: A country accepted in a beneficiary address.
      properties:
        aliases:
          description: Alternative names accepted for the country.
          items:
            type: string
          title: Aliases
          type: array
