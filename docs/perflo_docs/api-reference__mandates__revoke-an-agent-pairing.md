...
> Revokes one customer-owned pairing and cancels its unsent mandate executions. The pairing remains visible in the mandate audit history.



## OpenAPI

````yaml /api-reference/openapi.json delete /v1/mandates/{mandate_id}/pairings/{pairing_id}
openapi: 3.1.0
info:
  summary: >-
...
tags:
  ...
  - description: >-
    ...
    name: Webhooks
paths:
  /v1/mandates/{mandate_id}/pairings/{pairing_id}:
    delete:
      tags:
        - Mandates
      summary: Revoke an agent pairing
      description: >-
        Revokes one customer-owned pairing and cancels its unsent mandate
        executions. The pairing remains visible in the mandate audit history.
      operationId: revoke_agent_pairing
      parameters:
        - in: path
          name: mandate_id
          required: true
