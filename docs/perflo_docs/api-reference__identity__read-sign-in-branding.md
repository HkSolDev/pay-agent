...
# Read sign-in branding

> Returns the application name and mark the sign-in surface renders before anyone has authenticated. Takes no credential and makes no remote read.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/public-config
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/public-config:
    get:
      tags:
        - Identity
      summary: Read sign-in branding
      description: >-
        Returns the application name and mark the sign-in surface renders before
        anyone has authenticated. Takes no credential and makes no remote read.
      ...
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/PublicConfigView'
...
components:
  schemas:
    PublicConfigView:
      ...
      description: |-
        The branding the sign-in surface needs before any credential exists.

        It carries no customer data and no account data.
      properties:
        app_mark:
          description: The short mark to display beside the application name.
          title: App Mark
          type: string
        app_name:
        ...
        app_name_ar:
          anyOf:
            ...
            - type: 'null'
          description: >-
            The Arabic application name to display; null when none is
            configured.
          title: App Name Ar
      required:
        - app_name
