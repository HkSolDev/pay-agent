...
> Lists the payout countries currently accepted for new beneficiaries. Admits a customer token and answers synchronously.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/beneficiaries/countries
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/beneficiaries/countries:
    get:
      ...
      description: >-
        Lists the payout countries currently accepted for new beneficiaries.
        Admits a customer token and answers synchronously.
      operationId: beneficiary_countries
      responses:
        '200':
          content:
            application/json:
              schema:
                items:
                  $ref: '#/components/schemas/BeneficiaryCountryView'
                title: Response Beneficiary Countries
                type: array
...
components:
  schemas:
    BeneficiaryCountryView:
      additionalProperties: false
      description: A payout country accepted for new beneficiaries.
      properties:
        code:
