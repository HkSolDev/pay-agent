...
# Find service capabilities

> Finds normalized capabilities matching a query. Agent calls require services:read and a mandate_id query parameter naming current service-purchase authority.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/service-capabilities
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/service-capabilities:
    get:
      tags:
        - Services
      summary: Find service capabilities
      description: >-
        Finds normalized capabilities matching a query. Agent calls require
        services:read and a mandate_id query parameter naming current
        service-purchase authority.
      operationId: service_capabilities
      parameters:
        - in: query
          name: query
          required: true
          ...
          content:
            application/json:
              schema:
                ...
                title: Response Service Capabilities
                type: array
...
components:
  schemas:
    CapabilityView:
      ...
      description: A purchasable capability and its matching discovery rows.
      properties:
        description:
          anyOf:
            - type: string
            - type: 'null'
          description: The capability description; null when none is declared.
          title: Description
        id:
          description: The capability identifier accepted by service filters.
          title: Id
          type: string
        match_count:
          description: >-
            The number of capability-match rows Perflo returned for this
            identifier.
          minimum: 0
          title: Match Count
          type: integer
        name:
          description: The capability's display name.
          title: Name
          type: string
      required:
        - id
