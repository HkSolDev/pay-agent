...
> Registers a public HTTPS callback and returns its signing secret once.



## OpenAPI

````yaml /api-reference/openapi.json post /v1/webhook-subscriptions
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/webhook-subscriptions:
    post:
      ...
      description: Registers a public HTTPS callback and returns its signing secret once.
      ...
      responses:
        '201':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/WebhookSubscriptionCreatedView'
...
components:
  schemas:
    WebhookSubscriptionCreate:
      ...
      description: The callback endpoint that receives one customer's operation events.
      properties:
        url:
          description: The public HTTPS callback URL that receives operation events.
          format: uri
          maxLength: 2083
          minLength: 1
          title: Url
      ...
      type: object
    WebhookSubscriptionCreatedView:
      additionalProperties: false
      description: A newly registered callback and the signing secret returned only once.
      properties:
        created_at:
        ...
        signing_secret:
          description: >-
            The secret used to verify this subscription's HMAC-SHA256
            signatures. It is returned only by the creation response and cannot
            be read again.
          title: Signing Secret
          type: string
        url:
          description: The public HTTPS callback URL receiving operation events.
          format: uri
          maxLength: 2083
          minLength: 1
          title: Url
      ...
      required:
        ...
        - created_at
        - signing_secret
      title: WebhookSubscriptionCreatedView
      type: object
    ProblemDetails:
      additionalProperties: false
