...
# Read the spending account

> Returns held funds, promotional credit and owed balance for the signed-in customer. Agent tokens are refused.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/spending-account
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/spending-account:
    get:
      tags:
        - Spending
      summary: Read the spending account
      description: >-
        Returns held funds, promotional credit and owed balance for the
        signed-in customer. Agent tokens are refused.
      operationId: spending_account
      responses:
        '200':
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/SpendingAccountView'
...
components:
  schemas:
    SpendingAccountView:
      ...
      description: The customer's live Perflo spending position.
      properties:
        held:
          $ref: '#/components/schemas/NonNegativeMoney'
          description: Funds currently held for spending.
        owed:
          $ref: '#/components/schemas/NonNegativeMoney'
          description: The amount currently owed to Perflo.
        promotional_credit:
          $ref: '#/components/schemas/NonNegativeMoney'
          description: Promotional credit granted by Perflo.
      required:
        - held
        - promotional_credit
        - owed
      title: SpendingAccountView
      type: object
    ProblemDetails:
      additionalProperties: false
