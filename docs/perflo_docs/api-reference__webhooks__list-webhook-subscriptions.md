...
> Lists the authenticated customer's active webhook subscriptions without secrets.



## OpenAPI

````yaml /api-reference/openapi.json get /v1/webhook-subscriptions
openapi: 3.1.0
info:
  summary: >-
...
paths:
  /v1/webhook-subscriptions:
    get:
      ...
      description: >-
        Lists the authenticated customer's active webhook subscriptions without
        secrets.
...
components:
  schemas:
    WebhookSubscriptionView:
      ...
      description: One active callback registered for the authenticated customer.
      properties:
        created_at:
