  ...
  return (
    <form action={onSubmit} className="payee-form" aria-label="Add a new payee">
      <div className="payee-form-grid">
        ...
        <label>
          <span>Sender email identity</span>
          <input name="senderAddr" value={form.senderAddr} onChange={(e) => set("senderAddr", e.target.value)} />
        ...
        <label>
          <span>Per-payment cap (INR)</span>
          <input name="perPaymentCapInr" value={form.perPaymentCapInr} onChange={(e) => set("perPaymentCapInr", e.target.value)} />
