...
/**
 * Prisma 7's generated BYTEA input type is `Uint8Array<ArrayBuffer>`, which a
 * plain Node Buffer (`Uint8Array<ArrayBufferLike>`) doesn't structurally
 * satisfy — copy into a fresh, exactly-sized ArrayBuffer at this one
 * persistence boundary rather than at every call site.
 */
export function toPrismaBytes(value: Buffer): Uint8Array<ArrayBuffer> {
